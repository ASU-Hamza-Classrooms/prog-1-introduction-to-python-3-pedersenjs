...
def testWorkerClass(inputStr):
    ...
    worker1 = worker(inputStr)
    #Use the object to call each of the methods in the Worker class
    #Print the result of each call
    print("Input string is " + inputStr)
    print("Reverse of string is " + worker1.wreverseStr())
    print("Does string contain apple? " + worker1.wcontainsWord("apple"))
    print("Does string contain banana? " + worker1.wcontainsWord("banana"))
    print("Is string a palindrome? " + worker1.wisPalindrome())
    print("Uppercase of string is " + worker1.wupperCaseStr())
    return
